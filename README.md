...
<body bgcolor="grey">
    <div class="container">
        <h1>CALCULATOR</h1>
        <h2 class="text">PRIYADHARSHINI R (212223040155)</h2><br>
...
input {
    ...
    border-radius: 25px;
    border: 8px solid rgb(219, 237, 20);
    padding: 25px;
    background: rgb(238, 63, 14);
    font-size: 50px;
    height: 55x;
    width: 350px;
